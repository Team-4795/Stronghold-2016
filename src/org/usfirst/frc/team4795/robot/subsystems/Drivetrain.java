...
public class Drivetrain extends Subsystem {
	...
	public static final double WHEEL_SIZE = 6.0;
	
	double MAX_LATERAL_SPEED = 10; //feet per second
	double ANGULAR_CONVERSION_FACTOR = 1 / (2 * Math.PI * WHEEL_SIZE);
	...
	/*
	 * If percent mode, expects from -1 to 1
	 * If position mode, expects position in lateral feet
	 * If speed mode, expects position in lateral feet per second
	 */
